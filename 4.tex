...
\begin{figure}
    \centering
    \subfloat[Current method (ECAL)]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/SFs_2D_ECAL_Thesis.pdf}}
    \subfloat[NN method (ECAL)]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/SFs_2D_ECAL_Thesis_NN.pdf}}
...
\begin{figure}
    \centering
    \subfloat[Current method (HCAL)]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/SFs_2D_HCAL_Thesis.pdf}}
    \subfloat[NN method (HCAL)]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/SFs_2D_HCAL_Thesis_NN.pdf}}
...
\begin{figure}
    \centering
    \subfloat[Inclusive Response]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/NN_Performance/response_inclusive__ele.pdf}}
    
    \subfloat[Energy Resolution]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/NN_Performance/resolution_ptBins__ele.pdf}}
    \subfloat[Energy Scale]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/NN_Performance/scale_ptBins__ele.pdf}}
...
\begin{figure}
    \centering
    \subfloat[Rate]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/NN_Performance/rate_ObjEr2p5__ele.pdf}}
    ...
    \subfloat[Efficiency turn-on: $p_T>20$~GeV]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/NN_Performance/turnon_fixedObjRateEr2p5_20__ele.pdf}}
...
\begin{figure}
    \centering
    \subfloat[Inclusive Response]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/NN_Performance/response_inclusive__jet.pdf}}
    
    \subfloat[Energy Resolution]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/NN_Performance/resolution_ptBins__jet.pdf}}
    \subfloat[Energy Scale]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/NN_Performance/scale_ptBins__jet.pdf}}
...
\begin{figure}
    \centering
    \subfloat[Rate $|\eta|<2.5$]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/NN_Performance/rate_ObjEr2p5__jet.pdf}}
    ...
    \subfloat[Efficiency turn-on $|\eta|<2.5$: $p_T>60$~GeV]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/NN_Performance/turnon_fixedObjRateEr2p5_60__jet.pdf}}
...
\begin{figure}
    \centering
    \subfloat[Rate]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/NN_Performance/rate_Obj__jet.pdf}}
    ...
    \subfloat[Efficiency turn-on: $p_T>80$~GeV]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/NN_Performance/turnon_fixedObjRate_80__jet.pdf}}
...
\begin{figure} [h]
    \centering
    \subfloat[JAX method (ECAL)]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/SFs_2D_ECAL_Thesis_JAX.pdf}}
    \subfloat[JAX method (HCAL)]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/SFs_2D_HCAL_Thesis_JAX.pdf}}
...
\begin{figure}
    \centering
    \subfloat[Inclusive Response]{\includegraphics[width=0.5\linewidth]{Figures/L1TP/JAX_Performance/response_inclusive__ele.pdf}}
...
\begin{figure}
    \centering
    \subfloat[]{\includegraphics[width=0.4\linewidth]{Figures/L1TP/JAX_Layer2_Tau_NoIso.pdf}}
    \subfloat[]{\includegraphics[width=0.4\linewidth]{Figures/L1TP/JAX_Layer2_Tau_Iso.pdf}}
...
\begin{figure}
    \centering
    \subfloat[]{\includegraphics[width=0.4\linewidth]{Figures/L1TP/JAX_Layer2_EG_LooseIso.pdf}}
    \subfloat[]{\includegraphics[width=0.4\linewidth]{Figures/L1TP/JAX_Layer2_EG_TightIso.pdf}}
...
\section{Future applications} % 2/7
